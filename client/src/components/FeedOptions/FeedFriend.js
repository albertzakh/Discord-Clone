...
function FeedFriend({ username, profilePic, userHash }) {
  ...
  return (
    <div onMouseMove={() => setHashVisible(true)} onMouseOut={() => setHashVisible(false)} className="w-full border-b-[1px] border-gray px-[10px] py-[6px] flex flex-row hover:rounded-[8px] cursor-pointer hover:border-[#40444b] hover:bg-[#40444b]">
